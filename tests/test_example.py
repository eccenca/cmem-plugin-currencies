...
from cmem_plugin_currencies.example_transform import Lifetime
from cmem_plugin_currencies.example_workflow import DollyPlugin
from tests.utils import TestExecutionContext, needs_cmem

PROJECT_NAME = "currencies_test_project"
...
def di_environment() -> object:
    ...
    with io.StringIO("currencies plugin sample file.") as response_file:
        create_resource(
            project_name=PROJECT_NAME,
